...
class MapPlacesApi extends StatefulWidget {
  const MapPlacesApi({super.key});

  @override
  State<MapPlacesApi> createState() => _MapPlacesApiState();
}

class _MapPlacesApiState extends State<MapPlacesApi> {
  Set<Marker> markers = {};
